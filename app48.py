...
def preprocesar_stock_erp(df):
    ...
    Usa Ubicacion (AL6, ARENTO, TXT, AVITRANS...) como Almacen y filtra
    solo los almacenes relevantes para bandejas y envases."""
    df = df.copy()
...
# ══════════════════════════════════════════════
    ...
    with tab1:
        ...
        def _calcular_prev(row):
            ...
            # Stock teórico: stock operativo tras descontar la producción de hoy
            ...
            return pal_actual, pal_nec, pal_transito, pal_transito2, pal_teorico, seg_pal, cdm_pal, 0, estado, "#155724"
